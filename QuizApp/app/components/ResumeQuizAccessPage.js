...
var resume=jsonData.resume;
var resume1=jsonData.resume1;
var resume2=jsonData.resume2;
var resume3=jsonData.resume3;
...
export default class ResumeQuizAccessPage extends Component<Props> {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mainbox}>
        <Text style={styles.subjecttitle}>Resume Building</Text>
        ...
        <View style={styles.quiz1boxStack}>
          ...
          <View style={styles.levelbox}>
            <Text style={styles.resume1}>{resume1}</Text>
          </View>
        </View>
        <View style={styles.quiz1boxStack}>
          <View style={styles.quiz1box}>
          ...
          <View style={styles.levelbox}>
            <Text style={styles.resume1}>{resume2}</Text>
          </View>
        </View>
        <View style={styles.quiz1boxStack}>
          <View style={styles.quiz1box}>
          ...
          <View style={styles.levelbox}>
            <Text style={styles.resume1}>{resume3}</Text>
          </View>
        </View>
